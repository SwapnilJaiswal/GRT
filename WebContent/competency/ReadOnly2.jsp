...
<div>
		...
		<form id="AuditTrail" method="post" action="AuditTrailHandler">
		  ...
		  <input type="submit" name="History" value="History" style="float:right;top:10px;position:relative;" onclick="redirectToAuditPage()" />
		   <input type="submit" name="CloneRequest" value="Clone Project" style="float:right;top:10px;position:relative;" onclick="redirectToClonePage2()" />
		</form>
...
function redirectToClonePage2(){
	
	var SNO = $("#sno").val();
	//alert("redirectToClonePage2:"+SNO);
