...
<div class="form">
      ...
      <ul class="tab-group">
        ...
        <li class="tab"><a href="#login1">Deliverable classification</a></li>
        <li class="tab"><a href="#login1">Golden Rules</a></li>
        <li class="tab"><a href="#login1">Work Assingment</a></li>
        <li class="tab"><a href="#login1">Attach a file</a></li>
      </ul>
...
<div id="signup">
owner
<select name="Owner" id="Owner" style="width:320px" required>
								...
								Account NCE Name: <font color='red'>
										* </font></td>
								<td align="left"><input type="text" name="AccountNCEName"
									id="AccountNCEName" placeholder="Enter CEC ID"  style="width:300px;" required>
